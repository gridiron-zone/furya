...
This specification describes the usage and scope of random numbers on GRIDhub. This feature is currently in beta and please assess the risk yourself before using.

## Concepts

Currently, GRIDhub provides two random number generation methods: PRNG and TRNG.
...
On the basis of PRNG, the external random number factor `Oracle Seed` is introduced using the oracle machine method, implemented through GRIDhub Service.
